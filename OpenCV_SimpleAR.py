...
K = np.array([[1699.01686, 0, 973.294157],
              [0, 1675.16881, 480.758541],
              [0, 0, 1]])
dist_coeff = np.array([0.20711863, -0.77945631, -0.00091047, 0.00278646, 0.73768426])
board_pattern = (10, 7)
...
box_lower = board_cellsize * np.array([[3, 2, 0], [5, 2, 0], [5, 5, 0], [4, 5, 0], [4, 3, 0], [3, 3, 0]])
box_upper =board_cellsize * np.array([[3, 2, -1], [5, 2, -1], [5, 5, -1], [4, 5, -1], [4, 3, -1], [3, 3, -1]])
